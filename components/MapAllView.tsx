...
const MapAllView = () => {
  ...
  useEffect(() => {
    ...
    const initMap = async () => {
      ...
      const { AdvancedMarkerElement } = await loader.importLibrary('marker') as unknown as google.maps.MarkerLibrary;
      ...
      profiles.forEach((profile) => {
        ...
        // Create the custom marker with the AdvancedMarkerElement
        ...
        // Info window for when the marker is clicked
